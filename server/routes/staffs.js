...
const { register_staff, confirm_staff_reg_token, login_staff, get_staff, update_staff_data, reset_password, confirm_email, staff_reset_password } = require('../controllers/staff-controller');
...
router.post('/reset-password', staff_reset_password);
